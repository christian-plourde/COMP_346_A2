...
class BlockStack
{
	...
	public void push(final char pcBlock)
	{
		...
		//if the stack is empty we need to do something different
		try
		{
			if(isEmpty())
				throw new EmptyStackException();

			//if the stack was not empty this is the procedure to follow
		...
		{
			//if the stack was empty then we are here
	...
	/**
	 * Method to obtain the stack array.
